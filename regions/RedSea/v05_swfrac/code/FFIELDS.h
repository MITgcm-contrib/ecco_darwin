...
C     waterTyp2d :: Jerlov water (2d-map), time-dependent shortwave absorption
C
...
C     EfluxP - p-component of Eliassen-Palm flux vector
      ...
      COMMON /FFIELDS_phiTide/ waterTyp2d
      ...
      _RS  waterTyp2d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)

...
carried out to check the swfrac2d code:

STDOUT.0000_v05
is from running ecco_darwin/regions/RedSea/v05

STDOUT.0000_undef_ALLOW_WATERTYP
is from running ecco_darwin/regions/RedSea/v05_swfrac
but with "#undef ALLOW_WATERTYP" in CPP_OPTIONS.h

STDOUT.0000_no_waterTypFile
is from running ecco_darwin/regions/RedSea/v05_swfrac
but with "waterTypFile = ' '," in data.exf
...
Since the first four verification experiments default to

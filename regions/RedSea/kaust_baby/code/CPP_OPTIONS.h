C $Header: /u/gcmpack/MITgcm/verification/global_ocean.90x40x15/code/CPP_OPTIONS.h,v 1.7 2011/04/25 12:43:18 jmc Exp $
C $Name: checkpoint64u $

#ifndef CPP_OPTIONS_H
#define CPP_OPTIONS_H

C o read time-constant river/glacier run-off field
#define ALLOW_RUNOFF

...
C---  RBCS 3-D Fields:
     ...
     &          RBCsalt
chzh[     
      _RS RBC_maskA(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS RBC_maskH(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL RBCarea(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL RBCheff(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      COMMON /RBCS_MASKS_AH/
     &          RBC_maskA,
     &          RBC_maskH
      COMMON /RBCS_FIELDS_AH/
     &          RBCarea,
     &          RBCheff
chzh]     
...
chzh[     
      COMMON /RBCS_LOADED_AH/
     &                 rbca0, rbch0,
     &                 rbca1, rbch1
      _RS  rbca0    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  rbca1    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  rbch0    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS  rbch1    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
chzh]     

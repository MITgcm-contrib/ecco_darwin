...
CBOP
C     !ROUTINE: EXCH_R42_CUBE

C     !INTERFACE:
      SUBROUTINE EXCH2_R42_CUBE(
     U            array1, array2,
...
C     myThid      :: Thread number of this instance of S/R EXCH...
      ...
      _R4 array1(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      _R4 array2(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      LOGICAL signOption
...
C     in its copy of "array1" & "array2".
     ...
     O               e2Bufr1_R4(1,N,bi,bj,1), e2Bufr2_R4(1,N,bi,bj,1),
...
C-    Skip the call if this is an internal exchange
     ...
     I               e2Bufr1_R4(1,N,bi,bj,1), e2Bufr2_R4(1,N,bi,bj,1),
     O               e2_msgHandles(1,N,bi,bj),
...
C       Receive from neighbour N to fill buffer and later on the array
     ...
     I               e2BufrRecSize,
     I               iBufr1, iBufr2,
     I               e2Bufr1_R4(1,N,bi,bj,2), e2Bufr2_R4(1,N,bi,bj,2),
     I               W2_myCommFlag(N,bi,bj), myThid )
         ENDIF
        ENDDO
       ENDDO

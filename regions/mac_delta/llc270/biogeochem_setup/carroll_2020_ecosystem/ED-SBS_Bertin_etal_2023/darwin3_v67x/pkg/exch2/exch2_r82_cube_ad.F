...
CBOP
C     !ROUTINE: EXCH_R82_CUBE_AD

C     !INTERFACE:
      SUBROUTINE EXCH2_R82_CUBE_AD(
     U            array1, array2,
...
C     myThid      :: Thread number of this instance of S/R EXCH...
      ...
      _R8 array1(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      _R8 array2(1-myOLw:sNx+myOLe,
     &           1-myOLs:sNy+myOLn,
     &           myNz, nSx, nSy)
      LOGICAL signOption
...
C-    Skip the call if this is an internal exchange
     ...
     I               e2Bufr1_R8(1,N,bi,bj,2), e2Bufr2_R8(1,N,bi,bj,2),
...
C       Receive from neighbour N to fill buffer and later on the array
     ...
     I               e2BufrRecSize,
     I               iBufr1, iBufr2,
     I               e2Bufr1_R8(1,N,bi,bj,1), e2Bufr2_R8(1,N,bi,bj,1),
     I               W2_myCommFlag(N,bi,bj), myThid )
         ENDIF
        ENDDO
       ENDDO
...
C     in its copy of "array1" & "array2".
     ...
     I               thisTile, N,
     I               e2BufrRecSize,
     O               e2Bufr1_R8(1,N,bi,bj,1), e2Bufr2_R8(1,N,bi,bj,1),

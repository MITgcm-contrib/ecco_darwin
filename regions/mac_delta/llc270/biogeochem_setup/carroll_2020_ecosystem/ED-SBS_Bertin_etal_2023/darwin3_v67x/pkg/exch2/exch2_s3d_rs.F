...
CBOP
C     !ROUTINE: EXCH2_S3D_RS

C     !INTERFACE:
      SUBROUTINE EXCH2_S3D_RS(
     U                       phi,
     I                       myNz, myThid )

C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH2_S3D_RS
C     | o Handle Simple exchanges (= that ignore corners)
C     |   for _RS, 3-dim scalar arrays with overlap size = 1
C     *==========================================================*
...
C     myThid :: My thread id.
      INTEGER myNz
      _RS phi(0:sNx+1,0:sNy+1,myNz,nSx,nSy)
      INTEGER myThid

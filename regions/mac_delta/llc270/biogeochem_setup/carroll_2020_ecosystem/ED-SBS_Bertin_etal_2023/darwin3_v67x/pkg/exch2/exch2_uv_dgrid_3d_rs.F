...
CBOP
C     !ROUTINE: EXCH2_UV_DGRID_3D_RS

C     !INTERFACE:
      SUBROUTINE EXCH2_UV_DGRID_3D_RS(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH2_UV_DGRID_3D_RS
...
C
C  Calls: EXCH_RS (EXCH2_RS2_CUBE) ignoring sign
...
c      CALL EXCH2_RS2_CUBE( vPhi, uPhi, .FALSE., 'Cg',

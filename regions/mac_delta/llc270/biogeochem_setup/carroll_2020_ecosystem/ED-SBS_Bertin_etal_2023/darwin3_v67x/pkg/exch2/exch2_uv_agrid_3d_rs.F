...
CBOP
C     !ROUTINE: EXCH2_UV_AGRID_3D_RS

C     !INTERFACE:
      SUBROUTINE EXCH2_UV_AGRID_3D_RS(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH2_UV_AGRID_3D_RS
...
C
C  Calls: exch_RS (exch2_RS1_cube) - for each component
C
C*=====================================================================*
...
C     uLoc,vLoc     :: copies of the vector components with haloes filled.
      ...
      _RS uLoc(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      _RS vLoc(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      _RS negOne
...
C--   First call the exchanges for the two components
       ...
       CALL EXCH2_RS1_CUBE( uPhi, .FALSE., 'T ',
     ...
     I            EXCH_UPDATE_CORNERS, myThid )
       ...
       CALL EXCH2_RS1_CUBE( vPhi, .FALSE., 'T ',
     I            OLw, OLe, OLs, OLn, myNz,
     I            exchWidthX, exchWidthY,
     I            EXCH_IGNORE_CORNERS, myThid )
       CALL EXCH2_RS1_CUBE( vPhi, .FALSE., 'T ',
...
c      CALL EXCH2_3D_RS( uPhi, myNz, myThid )
c      CALL EXCH2_3D_RS( vPhi, myNz, myThid )

...
CBOP 0
C !ROUTINE: EXCH2_AD_GET_RS2

C !INTERFACE:
      SUBROUTINE EXCH2_AD_GET_RS2 (
...
C     sizeNb        :: Second dimension of e2Bufr1_RS & e2Bufr2_RS
C     sizeBi        :: Third  dimension of e2Bufr1_RS & e2Bufr2_RS
C     sizeBj        :: Fourth dimension of e2Bufr1_RS & e2Bufr2_RS
...
C     myThid        :: my Thread Id. number
      ...
      _RS     e2Bufr1_RS( e2BufrRecSize, sizeNb, sizeBi, sizeBj, 2 )
      _RS     e2Bufr2_RS( e2BufrRecSize, sizeNb, sizeBi, sizeBj, 2 )
...
#endif /* ALLOW_USE_MPI */
      ELSE
       STOP 'EXCH2_AD_GET_RS2:: commSetting VALUE IS INVALID'
      ENDIF
...
C     Read from e2Bufr1_RS(iBufr,sNb,sBi,sBj,sLv)
         iBufr1 = iBufr1+1
         ...
         iLoc = iBufr1
#endif
         e2Bufr1_RS(iLoc,sNb,sBi,sBj,sLv) = array1(itl,jtl,ktl)
         array1(itl,jtl,ktl) = 0.
        ENDDO
       ENDDO
      ENDDO
      IF ( iBufr1 .GT. e2BufrRecSize ) THEN
        WRITE(msgBuf,'(2A,I9,A,I9)') 'EXCH2_AD_GET_RS2:',
     &   ' iBufr1=', iBufr1, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_GET_RS2 (iBufr1 over limit)'
      ENDIF
...
C     Read from e2Bufr2_RS(iBufr,sNb,sBi,sBj,sLv)
         iBufr2 = iBufr2+1
#ifdef W2_USE_E2_SAFEMODE
         ...
         iLoc = iBufr2
#endif
         e2Bufr2_RS(iLoc,sNb,sBi,sBj,sLv) = array2(itl,jtl,ktl)
     ...
     &   ' iBufr2=', iBufr2, ' exceeds E2BUFR size=', e2BufrRecSize
        CALL PRINT_ERROR ( msgBuf, myThid )
        STOP 'ABNORMAL END: S/R EXCH2_AD_GET_RS2 (iBufr2 over limit)'
      ENDIF

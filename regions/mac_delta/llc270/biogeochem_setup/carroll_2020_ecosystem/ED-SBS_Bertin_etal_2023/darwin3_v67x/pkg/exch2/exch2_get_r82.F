...
CBOP 0
C !ROUTINE: EXCH2_GET_R82

C !INTERFACE:
      SUBROUTINE EXCH2_GET_R82 (
...
#endif /* ALLOW_USE_MPI */
      ELSE
       STOP 'EXCH2_GET_R82:: commSetting VALUE IS INVALID'
      ENDIF
...
C     Read from e2Bufr1_R8(iBufr,sNb,sBi,sBj,sLv)
         iBufr1 = iBufr1+1
         array1(itl,jtl,ktl) = e2Bufr1_R8(iBufr1,sNb,sBi,sBj,sLv)
        ENDDO
       ENDDO
      ENDDO
...
C     Read from e2Bufr2_R8(iBufr,sNb,sBi,sBj,sLv)
         iBufr2 = iBufr2+1
         array2(itl,jtl,ktl) = e2Bufr2_R8(iBufr2,sNb,sBi,sBj,sLv)
        ENDDO
       ENDDO
      ENDDO

...
CBOP
C     !ROUTINE: EXCH_RS_CUBE_AD

C     !INTERFACE:
      SUBROUTINE EXCH2_RS1_CUBE_AD(
     U            array,
...
C     in its copy of "array".
          CALL EXCH2_AD_PUT_RS1(
     I               tIlo, tIhi, tiStride,
     I               tJlo, tJhi, tjStride,
     I               tKlo, tKhi, tkStride,
     I               thisTile, N,
     I               e2BufrRecSize,
     I               e2Bufr1_RS(1,N,bi,bj,1),
     U               array(1-myOLw,1-myOLs,1,bi,bj),
     I               i1Lo, i1Hi, j1Lo, j1Hi, k1Lo, k1Hi,
     O               e2_msgHandles(1,N,bi,bj),
     I               W2_myCommFlag(N,bi,bj), myThid )

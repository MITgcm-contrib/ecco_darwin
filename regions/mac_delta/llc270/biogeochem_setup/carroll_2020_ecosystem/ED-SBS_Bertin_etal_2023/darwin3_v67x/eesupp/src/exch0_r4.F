...
C     myThid      :: my Thread Id number
      ...
      _R4     array( 1-myOLw:sNx+myOLe, 1-myOLs:sNy+myOLn,
     &               myNr, nSx, nSy )
      INTEGER exchWidthX
      INTEGER exchWidthY
      INTEGER cornerMode
...
C     myThid      :: thread number
      INTEGER myOLw, myOLe, myOLs, myOLn, myNr
      _R4     locFld( 1-myOLw:sNx+myOLe, 1-myOLs:sNy+myOLn, myNr )

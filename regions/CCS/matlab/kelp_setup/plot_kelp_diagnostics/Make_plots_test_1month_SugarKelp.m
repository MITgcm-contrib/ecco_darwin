...
inputDir='/nobackupp18/mmanizza/Kelp/CCS/run_test/diags/monthly/';

inputDir2='/nobackupp18/mmanizza/Kelp/CCS/run_test/diags/monthly2/';
...
MacFiles = dir([inputDir2 'MaC.0*data']);
MaNFiles = dir([inputDir2 'MaN.0*data']);
...
% surface fiedls only
cc = readbin([inputDir2 MacFiles(jt).name],[nx ny],1,'real*4');

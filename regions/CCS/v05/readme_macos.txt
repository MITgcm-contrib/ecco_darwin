...
# 2. Build executable
  cd build
  cp ../../ecco_darwin/regions/CCS/v05/code/SIZE.h_8 SIZE.h
  ../tools/genmake2 -mo ../../ecco_darwin/regions/CCS/v05/code -mpi \
   -of ../../ecco_darwin/regions/CCS/v05/code/darwin_arm64_gfortran
  make depend
  make -j
...
# inside the darwin3/run directory, for example,
  ...
  ln -sf <path_to_download_location>/CCS/run_template/* .

...
C     {fld}const      :: uniform default field value
      ...
      INTEGER WvHeightstartdate1
      INTEGER WvHeightstartdate2
      _RL     WvHeightStartTime
      _RL     WvHeightperiod
      _RL     WvHeightRepCycle
      _RL     WvHeightconst
      _RL     WvHeight_exfremo_intercept
      _RL     WvHeight_exfremo_slope
      CHARACTER*1 WvHeightmask

      INTEGER WvPeriodstartdate1
      INTEGER WvPeriodstartdate2
      _RL     WvPeriodStartTime
      _RL     WvPeriodperiod
      _RL     WvPeriodRepCycle
      _RL     WvPeriodconst
      _RL     WvPeriod_exfremo_intercept
      _RL     WvPeriod_exfremo_slope
      CHARACTER*1 WvPeriodmask
...
C-    File names.
      ...
      CHARACTER*(128) WvHeightfile
      CHARACTER*(128) WvPeriodfile
     ...
     &       WvHeightstartdate1, WvHeightstartdate2,
     &       WvPeriodstartdate1, WvPeriodstartdate2,
     ...
     &       WvHeightconst,    WvHeightRepCycle,
     &       WvHeightperiod,   WvHeightStartTime,
     &       WvPeriodconst,    WvPeriodRepCycle,
     &       WvPeriodperiod,   WvPeriodStartTime,
     ...
     &       WvHeight_exfremo_intercept,
     &       WvPeriod_exfremo_intercept,
     ...
     &       WvHeight_exfremo_slope,
     &       WvPeriod_exfremo_slope,
     ...
     &       WvHeightfile, WvHeightmask,
     &       WvPeriodfile, WvPeriodmask,
...
c     _RL     exf_inscal_sss
      ...
      _RL     exf_inscal_WvHeight
      _RL     exf_inscal_WvPeriod
      ...
      _RL     exf_outscal_WvHeight
      _RL     exf_outscal_WvPeriod
...
c    &                      exf_inscal_sss,
     ...
     &                      exf_outscal_WvHeight,
     &                      exf_outscal_WvPeriod,
     &                      exf_outscal_tidePot,

...
C     zen_fsol_daily     :: incoming solar radiation (daily mean)
     ...
     &     zen_albedo, zen_fsol_diurnal, zen_fsol_daily
      ...
      COMMON /exf_WvHeight_r/ WvHeight, WvHeight0, WvHeight1
      _RL WvHeight (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL WvHeight0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL WvHeight1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      COMMON /exf_WvPeriod_r/ WvPeriod, WvPeriod0, WvPeriod1
      _RL WvPeriod (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL WvPeriod0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL WvPeriod1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif

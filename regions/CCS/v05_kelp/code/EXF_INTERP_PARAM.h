...
C----
      ...
      _RL WvHeight_lon0,WvHeight_lon_inc
      _RL WvHeight_lat0,WvHeight_lat_inc(MAX_LAT_INC)
      INTEGER WvHeight_nlon,WvHeight_nlat,WvHeight_interpMethod
      _RL WvPeriod_lon0,WvPeriod_lon_inc
      _RL WvPeriod_lat0,WvPeriod_lat_inc(MAX_LAT_INC)
      INTEGER WvPeriod_nlon,WvPeriod_nlat,WvPeriod_interpMethod
     ...
     & WvHeight_lon0, WvHeight_lon_inc,
     & WvHeight_lat0, WvHeight_lat_inc,
     & WvPeriod_lon0, WvPeriod_lon_inc,
     & WvPeriod_lat0, WvPeriod_lat_inc,
     ...
     & WvHeight_nlon, WvHeight_nlat, WvHeight_interpMethod,
     & WvPeriod_nlon, WvPeriod_nlat, WvPeriod_interpMethod,

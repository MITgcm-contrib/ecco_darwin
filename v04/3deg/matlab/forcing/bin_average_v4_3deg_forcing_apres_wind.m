...
%}
%% 
gridDir = '/nobackup/hzhang1/pub/llc270/GRID/';
dataDir = '/nobackup/hzhang1/forcing/era-interim/';
saveDir1 = '../../data/';
...
flds={'EIG_pres_2000', 'EIG_ustr_2000', 'EIG_vstr_2000', 'EIG_wspeed_2000'};
for f=1:length(flds)
atemp.filename = flds{f};
...
writebin([saveDir1 atemp.filename],atemp.binMeanField,1,'real*4');

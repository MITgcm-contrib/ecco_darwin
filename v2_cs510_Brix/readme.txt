...
Global Attributes:
 ...
 InitialConditionsBGC     = 'Linear combination of the initial conditions of
                             ...
                             biogeochemical tracers (Greens functions run
                             ag4)'
 ...
 SurfaceForcingBGC        = 'Time and space variable atmospheric pCO2 blended
                             from daily 2009 GEOS-Chem results provided by
                             Kevin Bowman (JPL) on 3/3/2011 and global
                             atmospheric monthly means from NOAA
                             ESRL. Iron/dust climatological values from
                             Mahowald (2006).'
...
darwin_ag4:
Starting beginning of 2009 from a weighted comination of the ptracers and dic
pickup files from darwin runs 'a4v' 'a5v' 'a6v' 'a7v' 'a9v' with fact1 =
0.16033; fact2 = 0.56404; fact3 = -0.077899; fact4 = 0.10418; fact5 = 0.24935;
Base run is a5v. Factors are from Green's function analysis of these four runs
for 2009/10 using LDEO surface pCO2, Takahashi pCO2 climatology (variability,

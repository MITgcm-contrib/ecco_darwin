...
C Fugacity Factor added following Val Bennington 
      ...
      _RL  consumpDIC(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  consumpDIC_PIC(1-OLx:sNx+OLx,1-OLy:sNy+OLy,
     &  Nr,nSx,nSy)     
      _RL  DOCRemin(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  PReminC(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)

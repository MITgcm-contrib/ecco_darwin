...
C
C     Unchanged from Steph's original 1-deg set-up (DIAGNOSTICS_SIZE.h): every
C     PARAMETER here is already expressed in terms of the Nr symbol
C     from SIZE.h, so it tracks the LLC90 Nr=50 automatically.
      INTEGER    ndiagMax

...
C enable iron input from hydrothermal vents (Fe flux scaled to a real
C ventHe3 (Helium-3) forcing field via R_FeHe3_vent -- see data.darwin's
C ventHe3File block, added, following
C the exact recipe used by ecco_darwin's real GoM/llc90 (same grid as
C this port) and v06/llc270 configs). REQUIRES A REBUILD -- this is a
C compile-time flag, unlike most of this session's other fixes.

...
C#define EXF_ZERO_BOUND_AQH
C#define EXF_ZERO_BOUND_PRECIP
C#define EXF_ZERO_BOUND_SWDOWN
C#define NO_NIGHTTIME_CTRL_ADJ_TO_SWDOWN
C#define EXF_ZERO_BOUND_LWDOWN
C#define EXF_ZERO_BOUND_RUNOFF
C#define EXF_ZERO_BOUND_WSPEED

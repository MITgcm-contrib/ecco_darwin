...
for timeStep = 1:numFiles
    ...
    intTendV = tendV(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHConvV = adv_hConvV(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVConvV = adv_vConvV(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intForcV = forcV(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    
    intTendS = tendS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHAdvS = adv_hConvS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVAdvS = adv_vConvS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHDifS = dif_hConvS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVDifS = dif_vConvS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intForcS = forcS(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    
    intTendSal = tendSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHAdvSal = adv_hConvSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVAdvSal = adv_vConvSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHDifSal = dif_hConvSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVDifSal = dif_vConvSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intForcSal = forcSal(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    
    intTendDIC = tendDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHAdvDIC = adv_hConvDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVAdvDIC = adv_vConvDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intHDifDIC = dif_hConvDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVDifDIC = dif_vConvDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intForcDIC = forcDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)).* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intVirtualFluxDIC = virtualFluxDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);
    intBioDIC = bioDIC(:,:,intLevel);% .* convert2gcmfaces(dzMat(:,:,1:intLevel)) .* convert2gcmfaces(mygrid.hFacC(:,:,1:intLevel)),3);

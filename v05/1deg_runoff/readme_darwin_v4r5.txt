# v05 1deg Darwin3 simulation based on ECCOV4r5 set-up with daily point source 
# freshwater river discharge and associated biogeochemistry
#code base: c68g
...
../tools/genmake2 -of ../tools/build_options/linux_amd64_ifort+mpi_ice_nas \
	-mo "${MOD}/code_darwin_v4r5_v2 ../../ecco_darwin/v05/1deg/code_darwin_v4r5_v2 ${MOD}/code_v4r5_v2 ../../ecco_darwin/v05/1deg/code_v4r5_v2" -mpi
make depend
make -j 16

...
C      PARAMETER(darwin_nDiag=ifTph+nplank-1)
#else
...
C      PARAMETER(darwin_nDiag=iPPplank-1)
#endif
#ifdef DARWIN_OAE
      PARAMETER(iConsALKNO3=iPPplank+1)
      PARAMETER(iConsALKPIC=iConsALKNO3+1)
      PARAMETER(darwin_nDiag=iConsALKPIC)
#else

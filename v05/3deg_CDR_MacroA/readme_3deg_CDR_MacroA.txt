...
../tools/genmake2 -ieee -mo '../../ecco_darwin/v05/3deg_CDR_MacroA/code_darwin ../../ecco_darwin/v05/3deg/code ../../ecco_darwin/v05/llc270/code_darwin ../../ecco_darwin/v05/llc270/code'
 make depend
 make -j 8
...
#    Prerequisite: 2. Build executable
 ...
 cp ../../ecco_darwin/v05/3deg_CDR_MacroA/input/* .     
...
#    Prerequisite: 1. Get code
 ...
 cp ../../ecco_darwin/v05/3deg_CDR_MacroA/input/SIZE_16.h SIZE.h
 cp ../../ecco_darwin/v05/3deg_CDR_MacroA/input/DIAGNOSTICS_SIZE.h .

...
C 3deg: riverine BGC inputs (LOAC) are not available on the 128x64 grid.
C Leave undefined for the standalone/verification setup. To enable, regrid the
C 11 LOAC fields to 128x64 (see matlab/regrid_loac_runoff_to_3deg.m) and
C #define this, then uncomment the runoff block in input/data.darwin.

...
saveDir = '/Users/carrolld/Documents/research/bin_average/m_files/flux_conserving/from_dustin/offline/1x1_deg/';
...
for i = 1:length(XGsw(:))
    ...
    corners.XGse(i) = tile{t}.XG(I+1,J);
    corners.XGnw(i) = tile{t}.XG(I,J+1);
    corners.XGne(i) = tile{t}.XG(I+1,J+1);
...
save([saveDir 'cell_corners.mat'],'corners','-v7.3');

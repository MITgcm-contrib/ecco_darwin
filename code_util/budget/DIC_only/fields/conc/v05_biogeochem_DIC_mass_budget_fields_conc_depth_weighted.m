...
RF  = mygrid.mskC .* mygrid.hFacC .* mk3D(mygrid.DRF,mygrid.mskC);

vol = convert2gcmfaces(RF);
dz = vol;
...
for timeStep = 1:numFiles
    ...
    tendV = convert2gcmfaces(tendV) ./ sStarMean;
    adv_hConvV = convert2gcmfaces(adv_hConvV) ./ sStarMean;
    adv_vConvV = convert2gcmfaces(adv_vConvV) ./ sStarMean;
    forcV = convert2gcmfaces(forcV) ./ sStarMean;
    
    tendS = convert2gcmfaces(tendS) ./ sStarMean;
    adv_hConvS = convert2gcmfaces(adv_hConvS) ./ sStarMean;
    adv_vConvS = convert2gcmfaces(adv_vConvS) ./ sStarMean;
    dif_hConvS = convert2gcmfaces(dif_hConvS) ./ sStarMean;
    dif_vConvS = convert2gcmfaces(dif_vConvS) ./ sStarMean;
    forcS = convert2gcmfaces(forcS) ./ sStarMean;
    
    tendSal = convert2gcmfaces(tendSal) ./ sStarMean;
    adv_hConvSal = convert2gcmfaces(adv_hConvSal) ./ sStarMean;
    adv_vConvSal = convert2gcmfaces(adv_vConvSal) ./ sStarMean;
    dif_hConvSal = convert2gcmfaces(dif_hConvSal) ./ sStarMean;
    dif_vConvSal = convert2gcmfaces(dif_vConvSal) ./ sStarMean;
    forcSal = convert2gcmfaces(forcSal) ./ sStarMean;
    
    DIC = convert2gcmfaces(DIC);
    DICSnap1 = convert2gcmfaces(DICSnap1) ./ sStarMean;
    DICSnap2 = convert2gcmfaces(DICSnap2) ./ sStarMean; 
    tendDIC = convert2gcmfaces(tendDIC) ./ sStarMean;
    adv_hConvDIC = convert2gcmfaces(adv_hConvDIC) ./ sStarMean;
    adv_vConvDIC = convert2gcmfaces(adv_vConvDIC) ./ sStarMean;
    dif_hConvDIC = convert2gcmfaces(dif_hConvDIC) ./ sStarMean;
    dif_vConvDIC = convert2gcmfaces(dif_vConvDIC) ./ sStarMean;
    forcDIC = convert2gcmfaces(forcDIC) ./ sStarMean;
    virtualFluxDIC = convert2gcmfaces(virtualFluxDIC) ./ sStarMean;
    gDARDIC = convert2gcmfaces(gDAR_DIC) ./ sStarMean;
    
    bioConsDIC = convert2gcmfaces(bioCons_DIC) ./ sStarMean;
    bioConsDIC_PIC = convert2gcmfaces(bioCons_DIC_PIC) ./ sStarMean;
    bioRespDIC = convert2gcmfaces(bioResp_DIC) ./ sStarMean;
    bioReminDIC_DOC = convert2gcmfaces(bioRemin_DIC_DOC) ./ sStarMean;
    bioReminDIC_POC = convert2gcmfaces(bioRemin_DIC_POC) ./ sStarMean;
    bioDisscDIC_PIC = convert2gcmfaces(bioDissc_DIC_PIC) ./ sStarMean;
    
    %%
       
    %volume
    intTendV = sum((tendV(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHConvV = sum((adv_hConvV(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVConvV = sum((adv_vConvV(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intForcV = sum((forcV(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    
    intTotalV = intHConvV + intVConvV + intForcV;
    intResidualV = intTendV - intTotalV;
    
    %salt
    intTendS = sum((tendS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHAdvS = sum((adv_hConvS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVAdvS = sum((adv_vConvS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHDifS = sum((dif_hConvS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVDifS = sum((dif_vConvS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intForcS = sum((forcS(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    
    intTotalS = intHAdvS + intVAdvS + intHDifS + intVDifS + intForcS;
    intResidualS = intTendS - intTotalS;
    
    %salinity
    intTendSal = sum((tendSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHAdvSal = sum((adv_hConvSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVAdvSal = sum((adv_vConvSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHDifSal = sum((dif_hConvSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVDifSal = sum((dif_vConvSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intForcSal = sum((forcSal(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    
    intTotalSal = intHAdvSal + intVAdvSal + intHDifSal + intVDifSal + intForcSal;
    intResidualSal = intTendSal - intTotalSal;
    
    %DIC
    intDIC = sum((DIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intDICSnap1 = sum((DICSnap1(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intDICSnap2 = sum((DICSnap2(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intTendDIC = sum((tendDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHAdvDIC = sum((adv_hConvDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVAdvDIC = sum((adv_vConvDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intHDifDIC = sum((dif_hConvDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVDifDIC = sum((dif_vConvDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intForcDIC = sum((forcDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intVirtualFluxDIC = sum((virtualFluxDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intGDARDIC = sum((gDARDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    
    %DIC biology decomposition
    intBioConsDIC = sum((bioConsDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intBioConsDIC_PIC = sum((bioConsDIC_PIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intBioRespDIC = sum((bioRespDIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intBioReminDIC_DOC = sum((bioReminDIC_DOC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intBioReminDIC_POC = sum((bioReminDIC_POC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);
    intBioDisscDIC_PIC = sum((bioDisscDIC_PIC(:,:,startIntLevel:endIntLevel) .* dz(:,:,startIntLevel:endIntLevel)),3,nanString) ./ sum(dz(:,:,startIntLevel:endIntLevel),3,nanString);

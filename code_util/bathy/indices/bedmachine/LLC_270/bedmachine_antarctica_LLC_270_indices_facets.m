...
dx = 2; %bounding box for polygons
dy = 2;

%%

bedmachine = load([dataDir2 'bedmachine_antarctica_lon_lat_interp.mat']);
...
for i = 1:numFacets
    ...
    save([saveDir 'bedmachine_antarctica_LLC_270_indices_facet_' num2str(i) '_' suffix  '.mat'],'bathy','-v7.3');

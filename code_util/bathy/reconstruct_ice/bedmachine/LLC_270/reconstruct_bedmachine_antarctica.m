...
dataDir1 = '/Users/carrolld/Documents/research/bathy/mat/ice/bedmachine/antarctica/LLC_270/';
dataDir2 = '/Users/carrolld/Documents/research/bathy/grid/LLC_270/';
saveDir = '/Users/carrolld/Documents/research/bathy/mat/ice/bedmachine/antarctica/LLC_270/';
...
for i = 1:numFacets
    ...
    eval(['load([dataDir1 ''bedmachine_antarctica_LLC_270_indices_facet_' num2str(i) '_all_dustin.mat'']);']);
...
if saveBathy
    ...
    save([saveDir  'LLC_270_bedmachine_antarctica_ice_mask_dustin_method.mat'],'ice','mask','-v7.3');

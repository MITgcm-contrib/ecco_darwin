...
dataDir1 = '/Users/carrolld/Documents/research/bathy/mat/indices/Schaffer_2019/LLC_270/';
...
for i = 1:numFacets
    ...
    eval(['load([dataDir1 ''Schaffer_2019_ice_LLC_270_indices_facet_' num2str(i) '_' suffix '.mat'']);']);
...
if saveBathy
    ...
    writebin([saveDir  'LLC_270_ice_' saveSuffix '.bin'],depth,1,'real*4');
    save([saveDir  'LLC_270_ice_' saveSuffix '.mat'],'depth','-v7.3');
    
    cd(saveDir);
    
    close all
    
    testDepth = readbin([saveDir 'LLC_270_ice_' saveSuffix '.bin'],[nx ny],1,'real*4');

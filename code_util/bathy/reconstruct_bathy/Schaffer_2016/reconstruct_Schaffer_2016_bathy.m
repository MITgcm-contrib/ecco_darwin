...
dataDir1 = '/Users/carrolld/Documents/research/bathy/mat/indices/Schaffer_2016/LLC_270/';
...
for i = 1:numFacets
    ...
    eval(['load([dataDir1 ''Schaffer_2016_bathy_LLC_270_indices_facet_' num2str(i) '_' suffix '.mat'']);']);

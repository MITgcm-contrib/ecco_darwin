C $Header: /u/gcmpack/MITgcm_contrib/darwin/pkg/darwin/DARWIN_SIZE.h,v 1.8 2011/04/12 19:25:09 jahn Exp $
C $Name:  $
...
C MM
      ...
      PARAMETER (iO2TH = iZoc+2)
      PARAMETER (iO2AB = iO2TH+1)
      PARAMETER (iN2O = iO2AB+1)
      PARAMETER (iN2OTH = iN2O+1)
      PARAMETER (iAr = iN2OTH+1)
      PARAMETER (nDarwin=iAr+nzmax-2)

C      PARAMETER (nDarwin=iAr+nzmax-1)
C      PARAMETER (nDarwin=iZoC+nzmax-1)
